...
function HomeContainer(){
    ...
    const [HomeAtri,setHomeAtri]=useState({filteredText:'',view:'Filler',navName:"Filler"})
    const navigate=useNavigate()
    const {id}=useParams()
    
    function filterTextFun(value){
        setHomeAtri({filteredText:value,navName:"Filler",view:"Filler"})
    }
  
    function updateNavName(value){
        setHomeAtri({filteredText:'',navName:value,view:value})
    }
